...
#  has_many :terms
  ...
  def parish_desc
      if parish.name == 'Saint Helier'
      ...
      elsif parish.name == 'Saint Brelade'
        ...
        St. Brélade has some of the most popular bays in Jersey, with St. Brélades Bay, Ouaisné, Portelet and parts of both St. Ouens Bay and St. Aubins Bay falling within the parish boundaries. The village (or town) of Saint Aubin was originally a fishing port facing St. Helier on the opposite side of St. Aubins Bay. St Aubin was historically the main centre of population in the parish, but residential development at Les Quennevais has shifted that centre of population.'
      elsif parish.name == 'Saint Clement'
        'Saint Clement (Jèrriais: St Cliément). It is in the south east of the Island, and contains some of the suburbs of Saint Helier. It is the smallest parish by surface area, but the second most densely populated.  St. Clement stretches west to east from Le Dicq to within a quarter mile of La Rocque harbour (at the end of Rue de la Lourderie). Its surface area is around 1,044 acres (4.22 km2).
        ...
        Population (2011)	9,221.'
      elsif parish.name == 'Saint John'
        ...
        Population (2011) 2,911.'
      elsif parish.name == 'Saint Lawrence'
        ...
        Much of the parish is inland, though it has a short stretch of coastline in St. Aubins Bay. It borders St Peter and St Mary to the west, St John to the north and east, and St Helier to the east.
        Including the Connétable, the parish has three elected representatives in the States of Jersey.
        Area	9.5 km2
        Population (2011)	5,418.'
      elsif parish.name == 'Saint Martin'
        ...
        Population (2011)	3,763'
      elsif parish.name == 'Saint Mary'
        ...
        Population (2011) 1,752
        Density	270/km2 (700/sq mi)'
      elsif parish.name == 'Saint Ouen'
        ...
        It is reputed to be the most traditional of the parishes, being the farthest from Saint Helier and with much of the territory of the parish forming a peninsula. Its manor, Saint Ouens Manor, the seat of the de Carteret family for over eight centuries.
        ...
        Area	15 km2 (6 sq mi)
        Population (2011)	4,097
        Density	270/km2 (710/sq mi).'
      elsif parish.name == 'Saint Peter'
        'Saint Peter (Jèrriais: St Pièrre). It is in the west central part of the island. It is the only parish with two separate coastlines, stretching from St. Ouens Bay in the west to St. Aubins Bay in the south, and thereby cutting St. Brelade off from other parishes. The parish is the fourth-largest parish by surface area, covering 6,469 vergées (11.6 km2 (4.5 sq mi)).
        ...
        Population (2011) 5,003
        Density	430/km2 (1,100/sq mi).'
      elsif parish.name == 'Saint Saviour'
        'Saint Saviour (Jèrriais: St Saûveux/St Sauveur).
        ...
        Population (2011)	13,580,
        Density	1,500/km2 (3,800/sq mi).'
      elsif parish.name == 'Trinity'
        'Trinity (French: La Trinité, Jèrriais: La Trinneté). Located the north east of the island.
        ...
        Population (2011) 3,156,
        Density	260/km2 (660/sq mi).'
      elsif parish.name == 'Island Wide'
        'Senators'
      else
        'Parish description'
      end
